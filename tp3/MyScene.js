...
export class MyScene extends CGFscene {
    ...
    updateStackNumber() {
        this.prism.updateBuffersStacks(this.stackNumber);
        this.cylinder.updateBuffersStacks(this.stackNumber);
    }
    ...
    initMaterials() {
        ...
        this.material4.setAmbient(0.58, 0.29, 0, 1.0);
        this.material4.setDiffuse(0.58, 0.29, 0, 1.0);
        this.material4.setSpecular(0.05, 0.0001, 0, 1.0);
    ...
    display() {
        ...
        if(this.selectedObject == 5 || this.selectedObject == 6){ // if prism or cylinder
