...
export class ShaderScene extends CGFscene {
	...
	init(application) {
		...
		this.testShaders = [
			...
			new CGFshader(this.gl, "shaders/bicolor.vert", "shaders/bicolor.frag"),
		...
		this.testShaders[11].setUniformsValues({ uSamplerTex: 2 });
		this.testShaders[11].setUniformsValues({ uSamplerMap: 3 });
